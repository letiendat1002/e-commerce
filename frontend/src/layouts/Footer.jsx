        ...
        <div className="footer__container">
            <ul className="container chinhsach col-lg-3 col-md-6 col-sm-12 col-12">
                <li className="chinhsach--item">
                    <a href="#" style={{color: '#000', fontSize: '15px'}}>
                ...
                <li className="chinhsach--item" style={{display: 'flex'}}>
                    <img src={Footer1} alt="" style={{width:'50px', height: '50px'}}/>
                    <img src={Footer2} alt="" style={{width: '200px', height: '50px'}} />
                </li>            
            </ul>
            <ul className="chinhsach col-lg-3 col-md-6 col-sm-12 col-12">
                ...
                <li className="chinhsach--item">
                    <a href="#" style={{color: '#323030', fontSize: '15px'}}>
                        Chứng Nhận:
                    </a>
                </li>
                <li className="chinhsach--item" style={{display: 'flex'}}>
                    <img src={Footer3} alt="" style={{width: '100px', height: '40px'}}/>
                    <img src={Footer4} alt="" style={{width: '100px', height: '40px'}} />
                    <img src={Footer5} alt="" style={{width: '100px', height: '40px'}} />
                </li>            
            </ul>
            ...
            <ul className="chinhsach col-lg-3 col-md-6 col-sm-12 col-12">
                <li className="chinhsach--item">
                    ...
                    <p>1800 6611 <span>(Nhánh 1)</span></p>
                </li>
                <li className="chinhsach--item">
                ...
                <li className="chinhsach--item">
                    <span>Hỗ trợ thanh toán:</span><br />
                    <img src={Footer6} alt="" />
                    <img src={Footer7} alt="" />
                    <img src={Footer8} alt="" />
                    <img src={Footer9} alt="" />
                    <img src={Footer10} alt="" /><br/>
