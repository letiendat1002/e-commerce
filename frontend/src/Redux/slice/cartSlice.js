    ...
    reducers: {
        addToCart: (state, action) => {
            ...
            if (itemIndex >= 0){
                ...
                toast.success(
                    `${action.payload.Name.slice(0,20)} đã được thêm vào giỏ hàng`
                )
            }
            else {
...
export const { addToCart, removeFromToCart, decreamentFromCart, increamentFromCart } = cartSlice.actions
